...
attributes = {
    ...
    'Rapes (per capita)': 'rapesPerCap',
    'Auto Theft (per capita)':'autoTheftPerCap',
    'Larcenies (per capita)': 'larceniesPerCap',
    'Burglaries (per capita)': 'burglariesPerCap',
    'Arsons (per capita)': 'arsonsPerCap',
    'Non-Violent Crimes (per capita)': 'NonViolentCrimePerCap',
    'Violent Crimes (per capita)': 'ViolentCrimePerCap',
    'Household Size': 'householdsize',
    'Race Percent Black': 'racepctblack',
    'Race Percent White': 'racePctWhite',
    'Race Percent Asian': 'racePctAsian',
    'Race Percent Hispanic': 'racePctHisp',
    'Median Income (USD)': 'medIncome',
    'Median Family Income (USD': 'medFamInc',
    'Percent of Population Under Poverty': 'PctPopUnderPov',
    'Percent of Population not HS Graduate': 'PctNotHSGrad',
...
# Map the petalLength to y-axis
    y = attributes.get(opt2) + ':Q',
# Set the Tooltop
    tooltip=['communityName', 'population', attributes.get(opt1), attributes.get(opt2)],
